...
// Pring the entire array of Jupiter's moons
console.log(solarSystem[4].moons);

// Print Neptuune's moon "Nereid"
console.log(solarSystem[7].moons[1]);

// Add a new moon called "Endor" to Venus moon array
solarSystem[1].moons.push("Endor");

// Add a Pluto object containing name="Pluto", ringSystem=false, moons="Charon"
solarSystem.push({name: "Pluto", ringSystem: "false", moons: "Charon"});

// Add key pair to Eart object - diameter == 7917
solarSystem[2].diameter = 7917;

// Change Mercury's ringSystem to true
solarSystem[0].ringSystem = true;

// Change Uranus moon Umbriel to Oberon
solarSystem[6].moons[3] = "Oberon";

// Iterate through solarSystem array and print only objects with ringSystem true
...
// Sum of Jupiter, Saturn, Uranus, and Neptune satellites
